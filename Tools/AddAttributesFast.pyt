...
class helpers:
    ...
    # This functions calculates sinuosity, length to width ratio, and other shape attributes
    # for the Bathymetric High features
    def calculateSinuosity_LwR(self, workspace, tempFolder, inFeatClass, inBathy):
        ...
        # The idea is to find a point representing 'head' (or first) and
        # a point representing 'foot' (or last) of the feature
        for id in ids:
    ...
    # and thick_distance_correlation. They are used to classify Gully, Valley and Channel, and Canyon features.
    ...
    def calculate_profile_attributes_high(self, profileDF, depthCol, xCol, yCol, gap):
        ...
        # topSlopeClass: the slope class of the top of a bathymetic high;
